...
RcppExport SEXP _dpmclust_processInstances(SEXP muSEXP, SEXP xSEXP, SEXP lambdaSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(processInstances(mu, x, lambda));
...
static const R_CallMethodDef CallEntries[] = {
    {"_dpmclust_processInstances", (DL_FUNC) &_dpmclust_processInstances, 3},
